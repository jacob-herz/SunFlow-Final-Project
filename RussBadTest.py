...
>>> %Run RussBadTest.py
RussBadTest.py:180: RuntimeWarning: No channels have been set up yet - nothing to clean up!  Try cleaning up at the end of your program instead!
  GPIO.cleanup()
motor on
on
Process Process-1:
Traceback (most recent call last):
  ...
  File "/home/pi/Documents/Julia GUI test/RussBadTest.py", line 164, in run_motor
    while on:
...
Traceback (most recent call last):
  ...
  File "/home/pi/Documents/Julia GUI test/RussBadTest.py", line 164, in run_motor
    while on:
NameError: name 'on' is not defined
>>> invalid command name "3040493400check_dpi_scaling"
    while executing
"3040493400check_dpi_scaling"
    ("after" script)
invalid command name "3040493360update"
    while executing
"3040493360update"
    ("after" script)
